...
import './R3govtagcolldata.dart';

class R3agcollsdata extends StatefulWidget {
  R3agcollsdata({Key? key}) : super(key: key);
  @override
  State<R3agcollsdata> createState() => _R3agcollsdataState();
}

class _R3agcollsdataState extends State<R3agcollsdata> {
  List<Agcol> R1colls = [];
