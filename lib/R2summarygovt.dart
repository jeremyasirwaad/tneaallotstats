...
class R2Summarygovt extends StatefulWidget {
  const R2Summarygovt({Key? key}) : super(key: key);

  @override
  State<R2Summarygovt> createState() => _R2summarypagegovt();
}

class _R2summarypagegovt extends State<R2Summarygovt> {
  var agtotalcand = -1;
  var agtotalallocs = -1;
  var agtotalcols = -1;
  ...
  Future<dynamic> fetchAlbum() async {
    final response = await http.get(
        Uri.parse('http://3.110.226.121/api/api/master/r2stcount2/88888'),
        headers: {
          'x-auth-token':
