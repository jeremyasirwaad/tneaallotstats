...
class R2govtagcollsdata extends StatefulWidget {
  R2govtagcollsdata({Key? key}) : super(key: key);
  @override
  State<R2govtagcollsdata> createState() => _R2govtagcollsdataState();
}

class _R2govtagcollsdataState extends State<R2govtagcollsdata> {
  List<Agcol> R1colls = [];
  ...
  Future<dynamic> fetchAlbum() async {
    final response = await http.get(
        Uri.parse('http://3.110.226.121/api/api/master/r2stboard/88888'),
        headers: {
          'x-auth-token':
