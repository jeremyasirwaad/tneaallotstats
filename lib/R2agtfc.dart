...
class R2agtfc extends StatefulWidget {
  R2agtfc({Key? key}) : super(key: key);
  @override
  State<R2agtfc> createState() => _R2agtfcState();
}

class _R2agtfcState extends State<R2agtfc> {
  List<Agcol> R1TFC = [];
