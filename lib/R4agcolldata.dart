...
import 'package:tneadash2/R2govtagcolldata.dart';
...
import './R4govtagcolldata.dart';

class R4agcollsdata extends StatefulWidget {
  R4agcollsdata({Key? key}) : super(key: key);
  @override
  State<R4agcollsdata> createState() => _R3agcollsdataState();
}

class _R3agcollsdataState extends State<R4agcollsdata> {
  List<Agcol> R1colls = [];
  ...
  switch (item) {
    case 0:
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => R4agcollsdata()),
      );
      break;
    case 1:
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => R4govtagcollsdata()),
      );
      break;
  }
}
