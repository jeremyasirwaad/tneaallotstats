...
class R1summarycategory_wise extends StatefulWidget {
  R1summarycategory_wise({Key? key}) : super(key: key);
  @override
  State<R1summarycategory_wise> createState() => _R1summarycategory_wiseState();
}

class _R1summarycategory_wiseState extends State<R1summarycategory_wise> {
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Center(
                              ...
                              quarterTurns: 3,
                              child: Text(
                                "Provisional allotment joined 2",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 9),
                              ),
  ...
  switch (item) {
    case 0:
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => R1summarycategory_wise()),
      );
      break;
    case 1:
      Navigator.of(context).push(
