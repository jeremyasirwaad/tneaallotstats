...
import 'package:tneadash2/R1vgtfc.dart';
...
class R1govtvgtfc extends StatefulWidget {
  R1govtvgtfc({Key? key}) : super(key: key);
  @override
  State<R1govtvgtfc> createState() => _R1govtvgtfcState();
}

class _R1govtvgtfcState extends State<R1govtvgtfc> {
  List<Agcol> R1TFC = [];
  List<Agcol> R1FTCori = [];
