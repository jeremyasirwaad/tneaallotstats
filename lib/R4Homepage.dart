...
import 'package:tneadash2/R4Homepagegovt.dart';

class R4MyHomePage extends StatefulWidget {
  const R4MyHomePage({Key? key}) : super(key: key);

  @override
  State<R4MyHomePage> createState() => _R3MyHomePageState();
}

class _R3MyHomePageState extends State<R4MyHomePage> {
  var agtotalcand = -1;
  var agtotalallocs = -1;
  var agtotalcols = -1;
  var agtotalfts = -1;
  ...
  Future<dynamic> fetchAlbum() async {
    final response = await http.get(Uri.parse('${ip}r4stcount/88888'),
