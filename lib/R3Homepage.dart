...
import 'package:tneadash2/R3Homepagegovt.dart';

class R3MyHomePage extends StatefulWidget {
  const R3MyHomePage({Key? key}) : super(key: key);

  @override
  State<R3MyHomePage> createState() => _R3MyHomePageState();
}

class _R3MyHomePageState extends State<R3MyHomePage> {
  var agtotalcand = -1;
  var agtotalallocs = -1;
  var agtotalcols = -1;
  var agtotalfts = -1;
