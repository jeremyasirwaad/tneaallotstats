...
class R1Summarygovt extends StatefulWidget {
  const R1Summarygovt({Key? key}) : super(key: key);

  @override
  State<R1Summarygovt> createState() => _R1summarypagegovt();
}

class _R1summarypagegovt extends State<R1Summarygovt> {
  var agtotalcand = -1;
  var agtotalallocs = -1;
  var agtotalcols = -1;
  ...
  Future<dynamic> fetchAlbum() async {
    final response = await http.get(
        Uri.parse('http://3.110.226.121/api/api/master/stcount2/88888'),
        headers: {
          'x-auth-token':
                              ...
                              child: Container(
                                ...
                                child: FittedBox(
                                  ...
                                  child: Container(
                                    width: 150,
                                    child: Text(
                                      "Academic Govt total provisional allotments",
                                      style: GoogleFonts.roboto(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 14,
                                      ),
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Container(
                                  width: 150,
                                  child: Text(
                                    "Vocational Govt total candidates",
                                    style: GoogleFonts.roboto(
                                      fontWeight: FontWeight.w500,
                                      fontSize: 14,
                                    ),
                              ...
                              child: Container(
                                ...
                                child: FittedBox(
                                  ...
                                  child: Container(
                                    width: 150,
                                    child: Text(
                                      "Vocational Govt total provisional allotments",
                                      style: GoogleFonts.roboto(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 14,
                                      ),
                              ...
                              child: Container(
                                ...
                                child: FittedBox(
                                  ...
                                  child: Container(
                                    width: 150,
                                    child: Text(
                                      "Vocational Govt Joined College",
                                      style: GoogleFonts.roboto(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 14,
                                      ),
