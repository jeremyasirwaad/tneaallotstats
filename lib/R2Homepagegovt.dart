...
class R2MyHomePagegovt extends StatefulWidget {
  const R2MyHomePagegovt({Key? key}) : super(key: key);

  @override
  State<R2MyHomePagegovt> createState() => _R2MyHomePagegovtState();
}

class _R2MyHomePagegovtState extends State<R2MyHomePagegovt> {
  var agtotalcand = -1;
  var agtotalallocs = -1;
  var agtotalcols = -1;
  var agtotalfts = -1;
  ...
  Future<dynamic> fetchAlbum() async {
    final response = await http.get(Uri.parse('${gip}r2stcount/88888'),
...
void onSelected(BuildContext context, int item) {
  switch (item) {
    ...
    case 1:
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => R2MyHomePagegovt()),
      );
      break;
  }
}
