...
import 'package:tneadash2/R1vgcolldata.dart';
...
class R1govtvgcollsdata extends StatefulWidget {
  R1govtvgcollsdata({Key? key}) : super(key: key);
  @override
  State<R1govtvgcollsdata> createState() => _R1govtvgcollsdataState();
}

class _R1govtvgcollsdataState extends State<R1govtvgcollsdata> {
  List<Agcol> R1colls = [];
