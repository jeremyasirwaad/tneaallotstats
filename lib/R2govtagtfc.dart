...
class R2govtagtfc extends StatefulWidget {
  R2govtagtfc({Key? key}) : super(key: key);
  @override
  State<R2govtagtfc> createState() => _R2govtagtfcState();
}

class _R2govtagtfcState extends State<R2govtagtfc> {
  List<Agcol> R1TFC = [];
...
void onSelected(BuildContext context, int item) {
  switch (item) {
    ...
    case 1:
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => R2govtagtfc()),
      );
      break;
  }
}