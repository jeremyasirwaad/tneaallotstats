...
class R1govtagcollsdata extends StatefulWidget {
  R1govtagcollsdata({Key? key}) : super(key: key);
  @override
  State<R1govtagcollsdata> createState() => _R1govtagcollsdataState();
}

class _R1govtagcollsdataState extends State<R1govtagcollsdata> {
  List<Agcol> R1colls = [];
...
void onSelected(BuildContext context, int item) {
  switch (item) {
    ...
    case 1:
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => R1govtagcollsdata()),
      );
      break;
  }
}
