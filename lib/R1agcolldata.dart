...
class R1agcollsdata extends StatefulWidget {
  R1agcollsdata({Key? key}) : super(key: key);
  @override
  State<R1agcollsdata> createState() => _R1agcollsdataState();
}

class _R1agcollsdataState extends State<R1agcollsdata> {
  List<Agcol> R1colls = [];
