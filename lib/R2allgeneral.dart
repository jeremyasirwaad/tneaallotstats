...
class R2allgeneral extends StatefulWidget {
  const R2allgeneral({Key? key}) : super(key: key);

  @override
  State<R2allgeneral> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<R2allgeneral> {
  void calculatedata() {
    int anna_catg = 0;
