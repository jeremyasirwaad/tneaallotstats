...
class R2MyHomePage extends StatefulWidget {
  const R2MyHomePage({Key? key}) : super(key: key);

  @override
  State<R2MyHomePage> createState() => _R2MyHomePageState();
}

class _R2MyHomePageState extends State<R2MyHomePage> {
  var agtotalcand = -1;
  var agtotalallocs = -1;
  var agtotalcols = -1;
  var agtotalfts = -1;
